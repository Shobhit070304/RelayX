...
export default function DashboardPage() {
  ...
  return (
    <div className="relative min-h-screen bg-neutral-950 text-neutral-200 overflow-x-hidden font-sans selection:bg-neutral-800 selection:text-neutral-100">
      ...
      {toast && (
        <div className="fixed top-2 right-4 z-[200] max-w-sm w-full bg-neutral-900 border border-neutral-700 shadow-2xl rounded-lg p-4 font-mono text-xs animate-in slide-in-from-top-3 duration-200 space-y-2">
